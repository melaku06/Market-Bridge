...
export const db = {
  ...
  notifications: [
    ...
    { id: 'notif-006', user_id: 'usr-002', title: 'New Order #MB1256 Received', message: 'Sarah Johnson placed an order for 2 items. Total: $129.99', type: 'order' as const, icon: 'package', priority: 'high' as const, read: false, action_url: '/warehouse/orders/MB1256', created_at: '2024-05-20T10:24:00Z' },
    ...
    { id: 'notif-011', user_id: 'usr-002', title: 'New Order #MB1255 Received', message: 'Michael Brown placed an order for 2 items. Total: $249.00', type: 'order' as const, icon: 'package', priority: 'high' as const, read: true, action_url: '/warehouse/orders/MB1255', created_at: '2024-05-18T10:34:00Z' },

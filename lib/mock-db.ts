...
export const db = {
  ...
  warehouses: [
    { id: 'wh-001', user_id: 'usr-002', name: 'Elite Warehouse', owner_name: 'John Doe', email: 'john.doe@elitewarehouse.com', phone: '+1 (555) 123-4567', address: '456 Commerce Blvd, Suite 200', city: 'Los Angeles, CA 90001', country: 'United States', business_type: 'Electronics & Accessories', status: 'active' as WarehouseStatus, rating: 4.8, total_products: 156, total_orders: 3245, total_sales: 245890.50, performance_score: 96, member_since: '2023-03-15', bank_name: 'Chase Bank', bank_account: '•••• •••• •••• 7890', tax_id: '98-7654321' },
    { id: 'wh-002', user_id: 'usr-008', name: 'TechHub Warehouse', owner_name: 'Michael Brown', email: 'michael@techhub.com', phone: '+1 (555) 234-5678', address: '789 Tech Ave', city: 'New York, NY 10001', country: 'United States', business_type: 'Consumer Electronics', status: 'active' as WarehouseStatus, rating: 4.6, total_products: 98, total_orders: 1876, total_sales: 134560.20, performance_score: 91, member_since: '2023-04-10' },
    { id: 'wh-003', user_id: 'usr-009', name: 'Fashion Hub', owner_name: 'Emily Davis', email: 'emily@fashionhub.com', phone: '+1 (555) 345-6789', address: '321 Fashion Street', city: 'Miami, FL 33101', country: 'United States', business_type: 'Fashion & Apparel', status: 'active' as WarehouseStatus, rating: 4.4, total_products: 72, total_orders: 987, total_sales: 56780.90, performance_score: 88, member_since: '2023-05-05' },
    { id: 'wh-004', user_id: 'usr-010', name: 'Gadget Store', owner_name: 'David Wilson', email: 'david@gadgetstore.com', phone: '+1 (555) 456-7890', address: '654 Gadget Lane', city: 'Chicago, IL 60601', country: 'United States', business_type: 'Consumer Electronics', status: 'suspended' as WarehouseStatus, rating: 3.9, total_products: 64, total_orders: 543, total_sales: 32450.00, performance_score: 72, member_since: '2023-06-12' },
    { id: 'wh-005', user_id: 'usr-011', name: 'Home Essentials', owner_name: 'Sarah Johnson', email: 'sarah@homeessentials.com', phone: '+1 (555) 567-8901', address: '987 Home Ave', city: 'Dallas, TX 75201', country: 'United States', business_type: 'Home & Living', status: 'active' as WarehouseStatus, rating: 4.3, total_products: 48, total_orders: 765, total_sales: 43210.60, performance_score: 85, member_since: '2023-06-20' },
    { id: 'wh-006', user_id: 'usr-012', name: 'Style House', owner_name: 'Jessica Taylor', email: 'jessica@stylehouse.com', phone: '+1 (555) 678-9012', address: '159 Style Blvd', city: 'Seattle, WA 98101', country: 'United States', business_type: 'Fashion & Accessories', status: 'pending_approval' as WarehouseStatus, rating: 4.5, total_products: 55, total_orders: 432, total_sales: 28900.30, performance_score: 82, member_since: '2023-07-01' },
    { id: 'wh-007', user_id: 'usr-013', name: 'Sound World', owner_name: 'Daniel Lee', email: 'daniel@soundworld.com', phone: '+1 (555) 789-0123', address: '246 Audio Way', city: 'Atlanta, GA 30301', country: 'United States', business_type: 'Audio Equipment', status: 'active' as WarehouseStatus, rating: 4.7, total_products: 36, total_orders: 654, total_sales: 67890.10, performance_score: 93, member_since: '2023-07-10' },
    { id: 'wh-008', user_id: 'usr-014', name: 'Beauty Zone', owner_name: 'Olivia Martinez', email: 'olivia@beautyzone.com', phone: '+1 (555) 890-1234', address: '369 Beauty Lane', city: 'Phoenix, AZ 85001', country: 'United States', business_type: 'Beauty & Personal Care', status: 'suspended' as WarehouseStatus, rating: 4.1, total_products: 41, total_orders: 389, total_sales: 19450.80, performance_score: 75, member_since: '2023-07-15' },
  ] as Warehouse[],
  ...
  products: [
    { id: 'prod-001', name: 'Wireless Headphones Premium Sound', slug: 'wireless-headphones-premium', description: 'High quality sound with noise cancellation, long battery life and comfortable design.', short_description: 'Premium noise-cancelling wireless headphones', warehouse_id: 'wh-001', category_id: 'cat-001', category_name: 'Electronics', base_price: 50.00, margin_percent: 18.0, final_price: 59.99, discount_percent: 25, original_price: 79.99, images: ['https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.6, review_count: 128, sold_count: 1245, status: 'published' as ProductStatus, tags: ['wireless', 'bluetooth', 'headphones', 'audio'], brand: 'Sony', sku: 'WH-10001-BLK', weight: '250g', colors: ['Black', 'White', 'Navy'], created_at: '2024-01-10T00:00:00Z', updated_at: '2024-05-18T00:00:00Z' },
    { id: 'prod-002', name: 'Smart Watch Series 8', slug: 'smart-watch-series-8', description: 'Advanced smartwatch with health monitoring, GPS, and 48-hour battery life.', short_description: 'Feature-rich smartwatch with health tracking', warehouse_id: 'wh-002', category_id: 'cat-001', category_name: 'Electronics', base_price: 75.00, margin_percent: 16.7, final_price: 89.99, discount_percent: 0, original_price: 89.99, images: ['https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.5, review_count: 198, sold_count: 987, status: 'published' as ProductStatus, tags: ['smartwatch', 'health', 'GPS'], brand: 'TechBand', sku: 'WH-10001-002', weight: '45g', colors: ['Black', 'Silver', 'Gold'], created_at: '2024-01-15T00:00:00Z', updated_at: '2024-05-18T00:00:00Z' },
    { id: 'prod-003', name: "Men's Casual Shoes", slug: 'mens-casual-shoes', description: 'Comfortable and stylish casual shoes perfect for everyday wear.', short_description: 'Comfortable everyday casual shoes', warehouse_id: 'wh-003', category_id: 'cat-002', category_name: 'Fashion', base_price: 42.00, margin_percent: 16.0, final_price: 49.99, discount_percent: 0, original_price: 49.99, images: ['https://images.pexels.com/photos/2529148/pexels-photo-2529148.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.3, review_count: 76, sold_count: 654, status: 'published' as ProductStatus, tags: ['shoes', 'casual', 'men'], brand: 'UrbanStep', sku: 'WH-10001-003', weight: '0.6kg', colors: ['Black', 'White', 'Brown'], created_at: '2024-02-01T00:00:00Z', updated_at: '2024-05-17T00:00:00Z' },
    { id: 'prod-004', name: "Women's Handbag", slug: 'womens-handbag', description: 'Elegant leather handbag with multiple pockets and adjustable strap.', short_description: 'Premium leather handbag', warehouse_id: 'wh-003', category_id: 'cat-002', category_name: 'Fashion', base_price: 29.00, margin_percent: 17.0, final_price: 34.99, discount_percent: 0, original_price: 34.99, images: ['https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.2, review_count: 97, sold_count: 543, status: 'published' as ProductStatus, tags: ['handbag', 'women', 'leather'], brand: 'LuxStyle', sku: 'WH-10001-004', weight: '0.4kg', colors: ['Brown', 'Black'], created_at: '2024-02-05T00:00:00Z', updated_at: '2024-05-17T00:00:00Z' },
    { id: 'prod-005', name: 'Portable Speaker', slug: 'portable-bluetooth-speaker', description: '360-degree sound with 12-hour battery life and waterproof design.', short_description: '360° waterproof Bluetooth speaker', warehouse_id: 'wh-001', category_id: 'cat-001', category_name: 'Electronics', base_price: 25.00, margin_percent: 16.7, final_price: 29.99, discount_percent: 0, original_price: 29.99, images: ['https://images.pexels.com/photos/1279107/pexels-photo-1279107.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.4, review_count: 84, sold_count: 432, status: 'published' as ProductStatus, tags: ['speaker', 'bluetooth', 'portable'], brand: 'SoundWave', sku: 'WH-10021-005', weight: '0.32kg', colors: ['Black', 'Blue', 'Red'], created_at: '2024-02-10T00:00:00Z', updated_at: '2024-05-17T00:00:00Z' },
    { id: 'prod-006', name: 'Sunglasses UV400', slug: 'sunglasses-uv400', description: 'Polarized sunglasses with UV400 protection and lightweight frame.', short_description: 'UV400 polarized sunglasses', warehouse_id: 'wh-003', category_id: 'cat-002', category_name: 'Fashion', base_price: 16.00, margin_percent: 18.7, final_price: 19.99, discount_percent: 0, original_price: 19.99, images: ['https://images.pexels.com/photos/1362558/pexels-photo-1362558.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.3, review_count: 45, sold_count: 398, status: 'published' as ProductStatus, tags: ['sunglasses', 'UV400', 'polarized'], brand: 'SunStyle', sku: 'WH-10021-006', weight: '0.08kg', colors: ['Black', 'Brown', 'Gold'], created_at: '2024-02-15T00:00:00Z', updated_at: '2024-05-18T00:00:00Z' },
    { id: 'prod-007', name: 'Perfume Bottle', slug: 'perfume-bottle', description: 'Long-lasting floral fragrance with elegant bottle design.', short_description: 'Long-lasting floral fragrance', warehouse_id: 'wh-008', category_id: 'cat-003', category_name: 'Beauty', base_price: 20.00, margin_percent: 20.0, final_price: 24.99, discount_percent: 0, original_price: 24.99, images: ['https://images.pexels.com/photos/965989/pexels-photo-965989.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.6, review_count: 93, sold_count: 287, status: 'published' as ProductStatus, tags: ['perfume', 'fragrance', 'beauty'], brand: 'Essence', sku: 'WH-10021-007', weight: '0.15kg', colors: [], created_at: '2024-02-20T00:00:00Z', updated_at: '2024-05-18T00:00:00Z' },
    { id: 'prod-008', name: 'Gaming Mouse', slug: 'gaming-mouse', description: 'High precision gaming mouse with RGB lighting and 7 programmable buttons.', short_description: 'High precision RGB gaming mouse', warehouse_id: 'wh-002', category_id: 'cat-001', category_name: 'Electronics', base_price: 23.00, margin_percent: 17.4, final_price: 27.99, discount_percent: 0, original_price: 27.99, images: ['https://images.pexels.com/photos/2115257/pexels-photo-2115257.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.6, review_count: 66, sold_count: 432, status: 'published' as ProductStatus, tags: ['gaming', 'mouse', 'RGB'], brand: 'GameTech', sku: 'WH-10021-008', weight: '0.15kg', colors: ['Black'], created_at: '2024-03-01T00:00:00Z', updated_at: '2024-05-16T00:00:00Z' },
    // Pending approval products
    { id: 'prod-009', name: 'Bluetooth Earbuds Pro', slug: 'bluetooth-earbuds-pro', description: 'True wireless earbuds with ANC and 24-hour battery case.', short_description: 'ANC true wireless earbuds', warehouse_id: 'wh-001', category_id: 'cat-001', category_name: 'Electronics', base_price: 20.00, margin_percent: 20.0, final_price: 24.99, discount_percent: 28, original_price: 34.99, images: ['https://images.pexels.com/photos/3780681/pexels-photo-3780681.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 0, review_count: 0, sold_count: 0, status: 'pending' as ProductStatus, tags: ['earbuds', 'wireless', 'ANC'], brand: 'SoundPro', sku: 'WH-10021-009', weight: '0.05kg', colors: ['Black', 'White'], created_at: '2024-05-16T00:00:00Z', updated_at: '2024-05-16T00:00:00Z' },
    { id: 'prod-010', name: 'Fitness Watch Pro', slug: 'fitness-watch-pro', description: 'Advanced fitness tracker with heart rate, GPS, and sleep monitoring.', short_description: 'Full-featured fitness tracker', warehouse_id: 'wh-002', category_id: 'cat-001', category_name: 'Electronics', base_price: 58.00, margin_percent: 20.7, final_price: 69.99, discount_percent: 22, original_price: 89.99, images: ['https://images.pexels.com/photos/437038/pexels-photo-437038.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 0, review_count: 0, sold_count: 0, status: 'pending' as ProductStatus, tags: ['fitness', 'watch', 'health'], brand: 'FitPro', sku: 'WH-10021-010', weight: '0.04kg', colors: ['Black', 'Blue', 'Pink'], created_at: '2024-05-17T00:00:00Z', updated_at: '2024-05-17T00:00:00Z' },
    { id: 'prod-011', name: 'Backpack Travel Bag', slug: 'backpack-travel-bag', description: 'Durable travel backpack with multiple compartments and laptop sleeve.', short_description: '40L travel backpack with laptop sleeve', warehouse_id: 'wh-005', category_id: 'cat-002', category_name: 'Fashion', base_price: 33.00, margin_percent: 17.3, final_price: 39.99, discount_percent: 0, original_price: 39.99, images: ['https://images.pexels.com/photos/2905238/pexels-photo-2905238.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 0, review_count: 0, sold_count: 0, status: 'pending' as ProductStatus, tags: ['backpack', 'travel', 'laptop'], brand: 'TravelPro', sku: 'WH-10021-011', weight: '0.8kg', colors: ['Black', 'Navy', 'Gray'], created_at: '2024-05-16T00:00:00Z', updated_at: '2024-05-16T00:00:00Z' },
    { id: 'prod-012', name: 'LED Desk Lamp', slug: 'led-desk-lamp', description: 'Adjustable LED desk lamp with touch dimmer and USB charging port.', short_description: 'Adjustable LED desk lamp with USB', warehouse_id: 'wh-005', category_id: 'cat-004', category_name: 'Home & Living', base_price: 19.00, margin_percent: 17.3, final_price: 22.99, discount_percent: 0, original_price: 22.99, images: ['https://images.pexels.com/photos/1124982/pexels-photo-1124982.jpeg?auto=compress&cs=tinysrgb&w=600'], rating: 4.3, review_count: 52, sold_count: 189, status: 'published' as ProductStatus, tags: ['lamp', 'LED', 'desk'], brand: 'LightPro', sku: 'WH-10021-012', weight: '0.9kg', colors: ['White', 'Black'], created_at: '2024-03-10T00:00:00Z', updated_at: '2024-05-15T00:00:00Z' },
  ] as Product[],
  ...
  orders: [
    { id: 'MB1256', customer_id: 'usr-001', customer_name: 'Sarah Johnson', customer_email: 'sarah.johnson@email.com', customer_phone: '+1 (555) 123-4567', warehouse_id: 'wh-001', items: [{ product_id: 'prod-001', name: 'Wireless Headphones', image: 'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=100', price: 59.99, qty: 1 }, { product_id: 'prod-008', name: 'Gaming Mouse', image: 'https://images.pexels.com/photos/2115257/pexels-photo-2115257.jpeg?auto=compress&cs=tinysrgb&w=100', price: 27.99, qty: 1 }], subtotal: 87.98, shipping_fee: 10.00, discount: 0, tax: 0, total: 129.99, status: 'delivered' as OrderStatus, payment_method: 'Visa **** 4242', payment_status: 'paid' as const, shipping_address: '123 Maple Street, Apt 48', shipping_city: 'Los Angeles, CA 90001', shipping_method: 'Standard Shipping', tracking_number: 'FSR123456001', created_at: '2024-05-20T10:24:00Z', updated_at: '2024-05-20T14:15:00Z' },
    { id: 'MB1255', customer_id: 'usr-002', customer_name: 'Michael Brown', customer_email: 'michael.brown@email.com', customer_phone: '+1 (555) 234-5678', warehouse_id: 'wh-001', items: [{ product_id: 'prod-003', name: "Men's Casual Shoes", image: 'https://images.pexels.com/photos/2529148/pexels-photo-2529148.jpeg?auto=compress&cs=tinysrgb&w=100', price: 89.99, qty: 1, color: 'Black', size: '10' }, { product_id: 'prod-004', name: "Women's Handbag", image: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=100', price: 159.01, qty: 1, color: 'Brown' }], subtotal: 249.00, shipping_fee: 0, discount: 0, tax: 0, total: 249.00, status: 'shipped' as OrderStatus, payment_method: 'Visa **** 4242', payment_status: 'paid' as const, shipping_address: '700 Oak Street', shipping_city: 'San Francisco, CA 94102', shipping_method: 'Standard Shipping', tracking_number: 'FSR123456789', notes: 'Please handle with care. Gift packaging requested.', created_at: '2024-05-18T10:34:00Z', updated_at: '2024-05-19T09:30:00Z' },
    { id: 'MB1254', customer_id: 'usr-004', customer_name: 'Emily Davis', customer_email: 'emily.davis@email.com', warehouse_id: 'wh-002', items: [{ product_id: 'prod-011', name: 'Backpack Travel Bag', image: 'https://images.pexels.com/photos/2905238/pexels-photo-2905238.jpeg?auto=compress&cs=tinysrgb&w=100', price: 89.99, qty: 1 }], subtotal: 89.99, shipping_fee: 0, discount: 0, tax: 0, total: 89.99, status: 'processing' as OrderStatus, payment_method: 'PayPal', payment_status: 'paid' as const, shipping_address: '456 Pine Avenue', shipping_city: 'Chicago, IL 60601', shipping_method: 'Express Shipping', created_at: '2024-05-17T09:00:00Z', updated_at: '2024-05-17T11:00:00Z' },
    { id: 'MB1253', customer_id: 'usr-005', customer_name: 'David Wilson', customer_email: 'david.wilson@email.com', warehouse_id: 'wh-001', items: [{ product_id: 'prod-002', name: 'Smart Watch Series 8', image: 'https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=100', price: 89.99, qty: 1 }, { product_id: 'prod-005', name: 'Portable Speaker', image: 'https://images.pexels.com/photos/1279107/pexels-photo-1279107.jpeg?auto=compress&cs=tinysrgb&w=100', price: 109.01, qty: 1 }], subtotal: 199.00, shipping_fee: 0, discount: 0, tax: 0, total: 199.99, status: 'delivered' as OrderStatus, payment_method: 'Cash on Delivery', payment_status: 'cod' as const, shipping_address: '789 Oak Drive', shipping_city: 'Dallas, TX 75201', shipping_method: 'Standard Shipping', created_at: '2024-05-16T08:00:00Z', updated_at: '2024-05-17T14:00:00Z' },
    { id: 'MB1252', customer_id: 'usr-006', customer_name: 'Jessica Taylor', customer_email: 'jessica.taylor@email.com', warehouse_id: 'wh-001', items: [{ product_id: 'prod-009', name: 'Bluetooth Earbuds', image: 'https://images.pexels.com/photos/3780681/pexels-photo-3780681.jpeg?auto=compress&cs=tinysrgb&w=100', price: 49.99, qty: 1 }], subtotal: 49.99, shipping_fee: 0, discount: 0, tax: 0, total: 159.01, status: 'cancelled' as OrderStatus, payment_method: 'Credit Card', payment_status: 'refunded' as const, shipping_address: '321 Elm Street', shipping_city: 'Seattle, WA 98101', shipping_method: 'Standard Shipping', created_at: '2024-05-15T10:00:00Z', updated_at: '2024-05-15T12:00:00Z' },
    { id: 'MB1251', customer_id: 'usr-007', customer_name: 'Daniel Lee', customer_email: 'daniel.lee@email.com', warehouse_id: 'wh-001', items: [{ product_id: 'prod-001', name: 'Wireless Headphones', image: 'https://images.pexels.com/photos/3394650/pexels-photo-3394650.jpeg?auto=compress&cs=tinysrgb&w=100', price: 59.99, qty: 1 }, { product_id: 'prod-006', name: 'Sunglasses UV400', image: 'https://images.pexels.com/photos/1362558/pexels-photo-1362558.jpeg?auto=compress&cs=tinysrgb&w=100', price: 119.01, qty: 1 }], subtotal: 179.00, shipping_fee: 0, discount: 0, tax: 0, total: 179.99, status: 'delivered' as OrderStatus, payment_method: 'Visa **** 1234', payment_status: 'paid' as const, shipping_address: '654 Maple Road', shipping_city: 'Phoenix, AZ 85001', shipping_method: 'Express Shipping', created_at: '2024-05-14T08:00:00Z', updated_at: '2024-05-15T16:00:00Z' },
    { id: 'MB1250', customer_id: 'usr-008', customer_name: 'Olivia Martinez', customer_email: 'olivia.martinez@email.com', warehouse_id: 'wh-003', items: [{ product_id: 'prod-004', name: "Women's Handbag", image: 'https://images.pexels.com/photos/1152077/pexels-photo-1152077.jpeg?auto=compress&cs=tinysrgb&w=100', price: 34.99, qty: 1 }], subtotal: 34.99, shipping_fee: 0, discount: 0, tax: 0, total: 34.99, status: 'cancelled' as OrderStatus, payment_method: 'Credit Card', payment_status: 'refunded' as const, shipping_address: '987 Birch Lane', shipping_city: 'Atlanta, GA 30301', shipping_method: 'Standard Shipping', created_at: '2024-05-12T10:00:00Z', updated_at: '2024-05-12T11:00:00Z' },
  ] as Order[],

  notifications: [
    { id: 'notif-001', user_id: 'usr-001', title: 'Order #MB1255 has been shipped', message: 'Your order is on the way and will arrive soon.', type: 'order' as const, icon: 'truck', priority: 'high' as const, read: false, action_url: '/dashboard/orders/MB1255', created_at: '2024-05-19T09:30:00Z' },
    { id: 'notif-002', user_id: 'usr-001', title: 'Special Offer Just for You!', message: 'Get 20% off on your next purchase.', type: 'promotion' as const, icon: 'tag', priority: 'low' as const, read: false, created_at: '2024-05-18T12:00:00Z' },
    { id: 'notif-003', user_id: 'usr-001', title: 'Order Delivered', message: 'Your order #MB1253 has been delivered successfully.', type: 'order' as const, icon: 'check-circle', priority: 'medium' as const, read: true, created_at: '2024-05-17T14:00:00Z' },
    { id: 'notif-004', user_id: 'usr-002', title: 'New Order Received', message: 'You have received a new order #MB1256.', type: 'order' as const, icon: 'shopping-cart', priority: 'high' as const, read: false, action_url: '/warehouse/orders/MB1256', created_at: '2024-05-20T10:24:00Z' },
    { id: 'notif-005', user_id: 'usr-002', title: 'Low Stock Alert', message: '5 products are running low in stock.', type: 'inventory' as const, icon: 'alert-triangle', priority: 'high' as const, read: false, action_url: '/warehouse/inventory', created_at: '2024-05-20T08:15:00Z' },
    { id: 'notif-006', user_id: 'usr-003', title: 'New Product Awaiting Approval', message: 'Wireless Headphones Premium Sound needs review.', type: 'product' as const, icon: 'package', priority: 'high' as const, read: false, action_url: '/admin/products/prod-009/review', created_at: '2024-05-16T10:00:00Z' },
  ] as Notification[],
  ...
  analytics: {
    revenue: { today: 1234.50, week: 12450.80, month: 48920.40, total: 245890.50 },
    ...
    top_products: [
      { name: 'Wireless Headphones', units: 45, revenue: 2249.55 },
      { name: 'Smart Watch Series 8', units: 33, revenue: 2879.68 },
      { name: "Men's Casual Shoes", units: 27, revenue: 1399.72 },
      { name: 'Portable Speaker', units: 21, revenue: 629.79 },
      { name: "Women's Handbag", units: 18, revenue: 611.82 },
    ],
    sales_by_category: [
      { name: 'Electronics', revenue: 6125.40, percentage: 49 },
      { name: 'Fashion', revenue: 3245.30, percentage: 26 },
      { name: 'Accessories', revenue: 1899.20, percentage: 15 },
      { name: 'Beauty', revenue: 860.90, percentage: 7 },
      { name: 'Others', revenue: 360.00, percentage: 3 },
    ],
    weekly_revenue: [
      { date: 'May 12', revenue: 2000 }, { date: 'May 13', revenue: 2500 },
      { date: 'May 14', revenue: 3000 }, { date: 'May 15', revenue: 4000 },
      { date: 'May 16', revenue: 3500 }, { date: 'May 17', revenue: 4500 },
      { date: 'May 18', revenue: 6000 },
    ],
